...
import { LayoutDashboard, FolderOpen, PieChart, Layers, Settings, FileText, Users, Shield, ChevronLeft, ChevronRight, Menu, Receipt, Hammer, Tag } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentPage, onNavigate, currentUser }) => {
  ...
  const navItems = [
    ...
    { icon: Tag, label: 'Precios', page: Page.Precios },
